...
if ($ping['code'] === 0) {
    ...
    check('Excel is categorized by section groups', str_contains($export['body'], 'Report Categories Index') && str_contains($export['body'], 'A. Sales'));
    check('Excel top sellers include Category column', str_contains($export['body'], 'Category') && (str_contains($export['body'], 'Top Selling Items') || str_contains($export['body'], 'A. Sales')));
